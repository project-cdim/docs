...
| アラート管理UI   | [mf-alert][]          | アラートを管理するためのWeb UI画面を提供します。                             |
...
| 機能名                     | リポジトリ                        | 説明                                                                                                 |
| -------------------------- | --------------------------------- | ---------------------------------------------------------------------------------------------------- |
| 構成案設計                 | [layout-design][]                 | 指定された設計機構に構成案設計（新しい計算ノード群の構成設計）を要求し、設計結果を取得します。       |
| 制約条件管理               | [policy-manager][]                | 構成案設計の制約条件を管理します。                                                                   |
...
| 設計機構プラグイン(sample) | [sample-design-engine-plugin][]   | 設計機構のサンプル実装と、そのサンプル実装と連携するためのプラグインです。                           |
