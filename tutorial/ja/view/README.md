...
- [1.7. 構成反映状況の一覧を確認](#17-構成反映状況の一覧を確認)
- [1.8. 構成反映状況の詳細を操作確認](#18-構成反映状況の詳細を操作確認)
- [1.9. 注意事項](#19-注意事項)
...
| 5 |消費電力状況|直近1カ月間の消費電力量を確認します。初回の性能情報の更新時には、性能情報の蓄積のためにグラフが表示されるまで1時間ほど時間がかかります。|
...
- ログアウトする  
  ユーザボタンを選択後、ログアウトボタンを押すことでログアウトできます。
  ![](imgs/home-user.png)
  ![](imgs/home-login.png)
