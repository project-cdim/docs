...
| 6 |Control power                   |/cdim/api/v1/devices/{deviceID}/power       | PUT  |Controls the power of the device.
| 7 |Get OS boot status              |/cdim/api/v1/cpu/{CPUDeviceID}/is-os-ready  | GET  |Gets the boot status of the OS.
| 8 |Change configuration            |/cdim/api/v1/devices/{sourceDeviceID}/aggregations | PUT  |Controls the aggregation state between upstream side device and downstream side device.
